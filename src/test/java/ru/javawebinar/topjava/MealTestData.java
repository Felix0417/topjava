...
public class MealTestData {
    public static final MatcherFactory.Matcher<Meal> MEAL_MATCHER = usingIgnoringFieldsComparator(Meal.class, "user");

    public static final MatcherFactory.Matcher<MealTo> MEAL_TO_MATCHER = usingIgnoringFieldsComparator(MealTo.class);
